...
$postid = get_the_ID();
                        ...
                        $user_findings = get_posts(array(
                            ...
                            'meta_query' => array(
                                array(
                                    'key' => 'finding_event', // name of custom field
                        ...
                        <div id="related_findings" class="large-8 medium-12 small-12 columns clearfix end">
                            ...
                            <?php $content = get_post_field('post_content', $user_finding->ID);?>
                                <article><h5><a href="<?php echo $permalink; ?>" title="Go to <?php echo get_the_title( $user_finding->ID ); ?>"><?php echo get_the_title( $user_finding->ID ); ?></a></h5>
